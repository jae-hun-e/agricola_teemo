        ...
        return <div className="flex flex-col justify-center items-center gap-3">
            <div className="flex gap-3 flex-row h-full my-16 space-x-10">
                <div className="flex flex-col justify-center items-center" onClick={() => setIsLeft(true)}>
                    ...
                    <Image src="/assets/ACTION_01_1.png" width={250} height={180}/>
                    {isSow && <div className="flex justify-center items-center text-lg text-red-500">처리 완료</div>}
                </div>
                <div className="flex flex-col justify-center items-center" onClick={() => setIsLeft(false)}>
                    <div className="flex justify-center items-center text-lg">빵 굽기</div>
                    <Image src="/assets/ACTION_01_2.png" width={250} height={180}/>
                    {isBake && <div className="flex justify-center items-center text-lg text-red-500">처리 완료</div>}
                </div>
            </div>
        </div>;
    }
