        ...
        return <div className="flex flex-col justify-center items-center gap-3">
            <div className="flex gap-3 flex-row h-full my-24 space-x-10">
                <div className="flex flex-col justify-center items-center" onClick={() => setIsLeft(true)}>
                    ...
                    <Image src="/assets/ACTION_12_2.png" width={250} height={180}/>
                    {isFarm && <div className="flex justify-center items-center text-lg text-red-500">처리 완료</div>}
                </div>
                <div className="flex flex-col justify-center items-center" onClick={() => setIsLeft(false)}>
                    ...
                    <Image src="/assets/ACTION_12_1.png" width={250} height={180}/>
                    {isSeed && <div className="flex justify-center items-center text-lg text-red-500">처리 완료</div>}
                </div>
            </div>
        </div>;
    }
